...
import { ModalProductosComponent } from './modal/modal-productos.component';
...
export class ProductosComponent implements OnInit, AfterViewInit {
  ...
  public search             : string = '';
    ...
    displayedColumns: string[] = ['id', 'name', 'supplier', 'description', 'purchase_price', 'sale_price', 'stock', 'category', 'actions'];
